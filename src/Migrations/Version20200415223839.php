 ...
 */
final class Version20200415223839 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE universe (id INT AUTO_INCREMENT NOT NULL, label VARCHAR(255) NOT NULL, resume_universe LONGTEXT DEFAULT NULL, short_resume VARCHAR(255) DEFAULT NULL, rules LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
